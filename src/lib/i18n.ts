...
export const COPY: Record<Lang, Copy> = {
  en: {
    ...
    habits: {
      ...
      unitHint: "What the number counts.",
      target: "Target",
      targetHint: "Optional.",
      ...
      startTracking: "Go to activities",
      starting: "Starting…",
    ...
    onboarding: {
      ...
      reading: {
        title: "Reading",
        lead: "Set a yearly goal and reading list.",
        ...
        goalReachedPre: "That's the whole goal.",
        ...
        paceSubtitle: "The pace needed to finish the list within the year.",
      ...
      sleep: {
        ...
        title: "Sleep",
        lead: "The target bedtime and wake time set the default for the daily sleep log.",
        bedtime: "Bedtime",
        wake: "Wake time",
      },
      routine: {
        title: "Routine",
        lead: "The planned time blocks — the daily check measures how well they were followed.",
        start: "Start",
        end: "End",
        activity: "Activity",
      ...
      spirituality: {
        title: "Spirituality",
        lead: "The practices. Countable ones (like rosaries) get a daily number.",
        name: "Practice",
        countable: "Countable",
  ...
  pt: {
    ...
    habits: {
      ...
      startTracking: "Ir para atividades",
      starting: "Começando…",
    ...
    onboarding: {
      ...
      reading: {
        title: "Leitura",
        lead: "Defina uma meta anual e lista de leitura.",
        goal: "Livros no ano",
        goalUnit: "livros",
        ...
        goalReachedPre: "Essa é a meta completa.",
        ...
        paceSubtitle: "Ritmo necessário para terminar a lista dentro do ano.",
      ...
      routine: {
        title: "Rotina",
        lead: "Os blocos de horário — o check diário mede o quanto foram seguidos.",
        start: "Início",
        end: "Fim",
        activity: "Atividade",
      ...
      spirituality: {
        ...
        lead: "As práticas. As contáveis (como terços) ganham um número diário.",
        name: "Prática",
        countable: "Contável",
